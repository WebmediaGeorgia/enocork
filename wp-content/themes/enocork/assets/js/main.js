/******/ (() => {
  ...
  \*******************************/
      /***/ (
        ...
        /* harmony import */ var _components_swiper__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
            /*! ./components/swiper */ "./src/js/components/swiper.js"
          );
        /* harmony import */ var _components_modal__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(
            /*! ./components/modal */ "./src/js/components/modal.js"
          );
        /* harmony import */ var _components_observer__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./components/observer */ "./src/js/components/observer.js"
          );
        /* harmony import */ var _components_observer__WEBPACK_IMPORTED_MODULE_2___default =
          /*#__PURE__*/ __webpack_require__.n(
            _components_observer__WEBPACK_IMPORTED_MODULE_2__
          );
        /* harmony import */ var _components_different__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./components/different */ "./src/js/components/different.js"
          );
        /* harmony import */ var _components_different__WEBPACK_IMPORTED_MODULE_3___default =
          /*#__PURE__*/ __webpack_require__.n(
            _components_different__WEBPACK_IMPORTED_MODULE_3__
          );
        /* harmony import */ var _components_burger__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            /*! ./components/burger */ "./src/js/components/burger.js"
          );
        /* harmony import */ var _components_dynamic_adapt__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(
            /*! ./components/dynamic-adapt */ "./src/js/components/dynamic-adapt.js"
          );
        /* harmony import */ var _components_dynamic_adapt__WEBPACK_IMPORTED_MODULE_5___default =
          /*#__PURE__*/ __webpack_require__.n(
            _components_dynamic_adapt__WEBPACK_IMPORTED_MODULE_5__
          );
        /* harmony import */ var _components_accordion__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
            /*! ./components/accordion */ "./src/js/components/accordion.js"
          );
              ...
              accordionLinks.forEach((link) => {
                ...
                item?.addEventListener("click", () => {
                  ...
                  if (visuallySpanMenu == visuallySpanAccordion) {
                    ...
                    accordionBody.parentElement.classList.add(
  ...
  \*************************************/
      /***/ (
        ...
        "use strict";
        __webpack_require__.r(__webpack_exports__);
        /* harmony import */ var _functions_burger__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(
  ...
  \****************************************/
      /***/ () => {
        ...
        const breadcrumbs = document.querySelector(".breadcrumbs--contacts");
        if (breadcrumbs) {
        ...
        labels.forEach((label) => {
          ...
          if (
            ...
            labelSpan.textContent == "ფასდაკლება"
          ) {
            ...
            labelSpan.textContent == "დაწინაურება"
          ) {
            ...
            labelSpan.textContent == "ბესტსელერი"
          ) {
        ...
        const btnInstructionEn = document.querySelector(
          ".information-hide--en"
        );
        const btnInstructionGe = document.querySelector(
          ".information-hide--ge"
        );
          ...
          if (block.classList.contains("product-instruction")) {
            if (btnInstruction) {
              btnInstruction.addEventListener("click", () => {
                ...
                const btnShow = btnInstruction.querySelector(
                  ".information-hide__text"
                );

                if (btnShow.innerHTML === "Показать") {
                  btnShow.innerHTML = "Скрыть";
                } else {
                  btnShow.innerHTML = "Показать";
                }
              });
            }
            if (btnInstructionEn) {
              btnInstructionEn.addEventListener("click", () => {
                block.classList.toggle("show-instruction");
                btnInstructionEn
                  .querySelector(".information-hide__btn")
                  .classList.toggle("btnInstructionRotate");

                const btnShow = btnInstructionEn.querySelector(
                  ".information-hide__text"
                );
            ...
            if (btnInstructionGe) {
              btnInstructionGe.addEventListener("click", () => {
                block.classList.toggle("show-instruction");
                btnInstructionGe
                  .querySelector(".information-hide__btn")
                  .classList.toggle("btnInstructionRotate");

                const btnShow = btnInstructionGe.querySelector(
                  ".information-hide__text"
                );

                if (btnShow.innerHTML === "ჩვენება") {
                  btnShow.innerHTML = "დამალვა";
                } else {
                  btnShow.innerHTML = "ჩვენება";
                }
              });
            }
          }
        ...
        const breadcrumbsBack = document.querySelector(
  ...
  \***************************************/
      /***/ () => {
        ...
        if (sectionBottles) {
          ...
          // создаем наблюдатель
          const observerBottles = new IntersectionObserver(
            (entries, observer) => {
        ...
        if (sectionPartners) {
          ...
          const observerPartners = new IntersectionObserver(
            (entries, observer) => {
              ...
              entries.forEach((entry) => {
                // если элемент является наблюдаемым
                const cork = document.querySelector(
                  ".partners-block__red-image"
                );
          ...
          const observerFeedback = new IntersectionObserver(
            (entries, observer) => {
              ...
              entries.forEach((entry) => {
                ...
                if (
                  decorBarrel2.classList.contains("animation-decor-barrel2")
                ) {
  ...
  \*************************************/
      /***/ (
        ...
        const heroSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](
          ".hero-swiper",
          {
            slidesPerView: "auto",
            slidesPerGroup: 1,
        ...
        const productsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[
          "default"
        ](".products-swiper", {
          allowTouchMove: true,
          speed: 1000,
        ...
        const instaSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](
          ".insta-swiper",
          {
            slidesPerView: "auto",
            effect: "coverflow",
        ...
        const newProductsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__[
          "default"
        ](".new-products-swiper", {
          speed: 700,
          keyboard: {
        ...
        catalogSliders.forEach((slider) => {
          ...
          const catalogSliders = new swiper__WEBPACK_IMPORTED_MODULE_0__[
            "default"
          ](slider, {
            speed: 700,
            loop: false,
            ...
            navigation: {
              nextEl:
                slider.previousElementSibling.querySelector(".catalog-next"),
              prevEl:
                slider.previousElementSibling.querySelector(".catalog-prev"),
            },
          });
        ...
        const menuSliders = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](
          ".menu",
          {
            slidesPerView: "auto",
  ...
  \**************************************************/
      /***/ (
        ...
        const events = (swiper, method) => {
          const document = (0,
          ssr_window__WEBPACK_IMPORTED_MODULE_0__.getDocument)();
          const { params, touchEvents, el, wrapperEl, device, support } =
            swiper;
        ...
        function A11y({ swiper, extendParams, on }) {
          ...
          function updatePagination() {
            ...
            swiper.pagination.bullets.each((bulletEl) => {
              ...
              if (
                $bulletEl.is(`.${swiper.params.pagination.bulletActiveClass}`)
              ) {
  ...
  \************************/
    ...
    /* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(/*! ./_vars */ "./src/js/_vars.js");
    /* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_2__ =
...
const productAvailable = document.querySelector(".product-subtitle span");
if (productAvailable) {
  if (
    productAvailable.textContent != "В наличии" &&
    productAvailable.textContent != "In stock" &&
    productAvailable.textContent != "მარაგში"
  ) {
    productAvailable.parentElement.classList.add("product-subtitle--hide");
  } else {
    productAvailable.parentElement.classList.remove("product-subtitle--hide");
  }
}

function initMap() {
  const mapElFooter = document.getElementById("map");
  const mapElContacts = document.getElementById("map-contacts");

  const posFooter = {
    lat: 41.73106867161486,
    lng: 44.820555468738076,
  };
  const posContacts = {
    lat: 41.73106867161486,
    lng: 44.820555468738076,
  ...
  const mapFooter = new google.maps.Map(mapElFooter, optFooter);
  if (mapElContacts) {
    const mapContacts = new google.maps.Map(
      document.getElementById("map-contacts"),
      optContacts
    );

    const markerContacts = new google.maps.Marker({
      position: posContacts,
      map: mapContacts,
      icon: {
        url: "http://enocork/wp-content/themes/enocork/assets/img/location-marker.png",
