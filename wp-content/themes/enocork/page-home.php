...
<main class="main">
   ...
   <section class="about main-offset">
      <div class="container about__container">
         ...
         <div class="about-descr">
            ...
            <?php if (ICL_LANGUAGE_CODE == 'ru') : ?>
               <a href="<?php echo home_url('/about'); ?>" class="about-descr__btn btn-primary btn-reset">Подробнее</a>
            <?php elseif (ICL_LANGUAGE_CODE == 'en') : ?>
               <a href="<?php echo home_url('/en/about'); ?>" class="about-descr__btn btn-primary btn-reset">More</a>
            <?php elseif (ICL_LANGUAGE_CODE == 'ge') : ?>
               <a href="<?php echo home_url('/ge/about'); ?>" class="about-descr__btn btn-primary btn-reset">მეტი</a>
            <?php endif; ?>
         </div>
      </div>
   </section>
         ...
         <div class="partners-block__descr">
            ...
            <div class="partners-block__animation">
               ...
               <div class="partners-block__animation-text">
                  ...
                  <?php if (ICL_LANGUAGE_CODE == 'ru') : ?>
                     <a href="<?php echo home_url('/about'); ?>" class="btn-primary btn-reset">Подробнее</a>
                  <?php elseif (ICL_LANGUAGE_CODE == 'en') : ?>
                     <a href="<?php echo home_url('/en/about'); ?>" class="btn-primary btn-reset">More</a>
                  <?php elseif (ICL_LANGUAGE_CODE == 'ge') : ?>
                     <a href="<?php echo home_url('/ge/about'); ?>" class="btn-primary btn-reset">კატალოგში გადასვლა</a>
                  <?php endif; ?>
               </div>
            </div>
         </div>
   ...
   <section class="new-products main-offset">
      <div class="container new-products__container">
         <?php if (ICL_LANGUAGE_CODE == 'ru') : ?>
            <h2 class="page-title new-products__title">Новые продукты</h2>
         <?php elseif (ICL_LANGUAGE_CODE == 'en') : ?>
            <h2 class="page-title new-products__title">New products</h2>
         <?php elseif (ICL_LANGUAGE_CODE == 'ge') : ?>
            <h2 class="page-title new-products__title">ახალი პროდუქტები</h2>
         <?php endif; ?>
